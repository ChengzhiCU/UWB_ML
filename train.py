...
train_dataset = UWBDataset(
    labeled_path=os.path.join(config.PAESED_FILES, 'all_12.npy'),
    unlabelled_path=[],
...
lr_scheduler_non_D = lr_scheduler.ExponentialLR(optimizer=opt_non_D, gamma=0.5 ** (1/50))
...
print('best test loss = {},  in meter average error = {}'.format(metric, metric ** 0.5))
