...
'''
nlos_folder336 = os.path.join(config.Data_root_path, 'los_data_block_new_6f')
data = np.load(os.path.join(nlos_folder336, 'all_258.npy'))[()]
index = np.load(os.path.join(nlos_folder336, 'train_tr_ind_sep.npy'))
index_test = np.load(os.path.join(nlos_folder336, 'test_ind_sep.npy'))
index_val = np.load(os.path.join(nlos_folder336, 'train_val_ind_sep.npy'))
'''
'''
nlos_folder336 = os.path.join(config.Data_root_path, 'data_block_nlos_6f')
data = np.load(os.path.join(nlos_folder336, 'all_436.npy'))[()]
index = np.load(os.path.join(nlos_folder336, 'train_tr_ind_sep.npy'))
index_test = np.load(os.path.join(nlos_folder336, 'test_ind_sep.npy'))
index_val = np.load(os.path.join(nlos_folder336, 'train_val_ind_sep.npy'))

'''
nlos_folder336 = os.path.join(config.Data_root_path, 'data_block_losnew_nlosold')
data = np.load(os.path.join(nlos_folder336, 'all_694.npy'))[()]
index = np.load(os.path.join(nlos_folder336, 'train_tr_ind_sep.npy'))
index_test = np.load(os.path.join(nlos_folder336, 'test_ind_sep.npy'))
index_val = np.load(os.path.join(nlos_folder336, 'train_val_ind_sep.npy'))
...
index = np.append(index,index_val)

train_num = index.shape[0]

feature_o = data['extracted_features']

feature = preprocessing.scale(feature_o) 
...
clf = svm.SVR(kernel = 'rbf', max_iter = 6000)
